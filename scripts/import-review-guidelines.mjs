...
mkdirSync(resolve(root, 'src/shared/guidelines'), { recursive: true });
writeFileSync(resolve(root, 'src/shared/guidelines/source.json'), JSON.stringify({ source: basename(source), revision, rules }, null, 2) + '\n');
