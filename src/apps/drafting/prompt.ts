...
export function buildUserPrompt(context: RowRewriteContext): string {
  return [
    ...
    "Будь внимателен к пунктуации, особенно вокруг междометий и частиц вроде 'ну', 'а', 'э'.",
    "Если встречается обычное число без речевого искажения, нормализуй его как '123 {СКАЗ: ...}'.",
