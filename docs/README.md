...
This directory holds the durable review workflow material that used to live in the parent `reviewer/` wrapper.

## Contents

- `review-feedback-spec.md`: local product spec for the review-feedback workflow and scoring shape.
